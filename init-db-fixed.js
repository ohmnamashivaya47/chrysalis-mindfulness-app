...
async function initializeDatabase() {
  ...
  try {
    ...
    await client.query('CREATE INDEX IF NOT EXISTS idx_friendships_user1 ON friendships(user1_id);');
    await client.query('CREATE INDEX IF NOT EXISTS idx_friendships_user2 ON friendships(user2_id);');
    await client.query('CREATE INDEX IF NOT EXISTS idx_friend_requests_from ON friend_requests(from_user_id);');
    await client.query('CREATE INDEX IF NOT EXISTS idx_friend_requests_to ON friend_requests(to_user_id);');
