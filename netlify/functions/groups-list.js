const { db, initDB } = require('./lib/neon-db.js');
...
const handler = async (event, context) => {
  ...
  try {
    ...
    const userGroups = await db.groups.getUserGroups(authUser.userId);
    const publicGroups = await db.groups.getPublicGroups();
